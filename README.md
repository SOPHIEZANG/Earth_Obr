...
- The following is the design of functions in the software with Python:
    ...
    - (5) get_bands_plot(): plot the city or area of interest with NDVI color as a map picture which can be saved to your disk. ![markdown picture](./NDVI.png)   ![markdown picture](./ndvi_shanghai.png)  ![markdown picture](./ndvi_beijing.png)  
